...
const HeroSection = () => {
  ...
  return (
    <>
      <section id="home" className="section-spacing bg-gradient-to-br from-blue-50 to-purple-50 overflow-hidden">
            ...
            <div className="space-y-8">
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl">
                  Join imisi HealthCARE — a data privacy-compliant and secured platform 
                  seamlessly connecting patients, healthcare providers, healthcare facilities, 
                  and stakeholders for a prompt and personalized healthcare experience across Africa.
                </p>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-primary-blue">54</div>
                  <div className="text-sm text-gray-600">African Countries</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-primary-blue">1.4B+</div>
                  <div className="text-sm text-gray-600">People Served</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-primary-blue">24/7</div>
                  ...
                  <div className="absolute inset-0">
                    <svg className="w-full h-full" viewBox="0 0 400 400">
                      <defs>
                        ...
                        >
                          <stop offset="0%" stopColor="#000EC3" stopOpacity="0.2" />
                          <stop offset="50%" stopColor="#A92CDF" stopOpacity="0.6" />
                          <stop offset="100%" stopColor="#000EC3" stopOpacity="0.2" />
                        </motion.linearGradient>
                      </defs>
