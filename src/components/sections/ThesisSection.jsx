...
const ThesisSection = () => {
  ...
  return (
    <section id="thesis" className="section-spacing bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        >
          ...
          <div className="space-y-8">
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                Building Africa's First AI-Powered Healthcare Operating System
              </h2>
              
              <p className="text-xl text-gray-600 leading-relaxed">
                imisi HealthCARE is building Africa's first AI-powered, blockchain-secured healthcare 
                operating system—a modular digital ecosystem that delivers prompt and personalized 
                healthcare by seamlessly connecting patients, healthcare providers, healthcare 
                facilities, pharmaceutical vendors, and public health stakeholders across the continent.
              </p>
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            <div className="relative w-full h-96 lg:h-[500px] rounded-2xl bg-gradient-to-br from-primary-blue/10 to-secondary-vibrantPurple/10 p-8 flex items-center justify-center overflow-hidden">
              ...
              >
                <svg className="w-5 h-5 text-secondary-vibrantPurple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
